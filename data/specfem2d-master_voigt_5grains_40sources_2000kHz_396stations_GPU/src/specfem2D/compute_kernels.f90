...
! see e.g. Tromp et al. (2005)
  ...
  if (.not. GPU_MODE) then
    ...
    do ispec = 1,nspec
      ...
      do j = 1,NGLLZ
        do i = 1,NGLLX
          ...
          !xyw 2025/3/13
          ! Print values for specific (i,j,ispec)
          !if (i == 1 .and. j == 1 .and. (ispec >= 1 .and. ispec <= 5)) then
          !    print *, 'Fortran: ispec =', ispec, 'i =', i, 'j =', j, 'iglob =', iglob
          !    print *, 'dux_dxl:', dux_dxl
          !    print *, 'b_dux_dxl:', b_dux_dxl
          !    print *, 'dsxx:', dsxx
          !    print *, 'b_dsxx:', b_dsxx
          !    print *, '--------------------------------------------------------------------------------'
          !endif
    ...
    !xyw 2025/3/15
    !print *, 'c11_k(1)', c11_k_loc(1)
    !print *, 'c11_k(10)', c11_k_loc(10)
    !print *, 'c11_k(100)', c11_k_loc(100)
    
    !print *, 'c11_kl(1,1,1)', c11_kl(1,1,1)
    !print *, 'c11_kl(1,1,200)', c11_kl(1,1,200)
    !print *, 'c13_kl(1,1,200)', c13_kl(1,1,200)
