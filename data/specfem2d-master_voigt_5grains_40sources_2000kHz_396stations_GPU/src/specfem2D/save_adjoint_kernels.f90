...
!
  ...
  do ispec = 1, nspec
    if (ispec_is_elastic(ispec)) then
      ...
      if (ispec_is_anisotropic(ispec)) then
        ...
        !print *, 'deltat', deltat
        !print *, 'NTSTEP_BETWEEN_COMPUTE_KERNELS', NTSTEP_BETWEEN_COMPUTE_KERNELS
  ...
  !xyw 2025/3/9
  !print *, 'ispec_is_anisotropic = ', ispec_is_anisotropic(ispec)
  !print *, 'iglob', iglob
  !print *, 'c11_kl(1,1,1)', c11_kl(1,1,1)
  !print *, 'c11_kl(1,1,200)', c11_kl(1,1,200)
  !print *, 'c13_kl(1,1,200)', c13_kl(1,1,200)
  !print *, 'rhop_kl(1,1,100)', rhop_kl(1,1,100)
  !print *, 'rhop_kl(1,1,200)', rhop_kl(1,1,200)
